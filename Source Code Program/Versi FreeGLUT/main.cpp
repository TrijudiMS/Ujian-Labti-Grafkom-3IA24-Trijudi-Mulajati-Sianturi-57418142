#include <Windows.h>
#include <GL/glut.h>        //UBAH LINE INI MENJADI KOMENTAR JIKA PENGGUNA MENGGUNAKAN FREEGLUT
#include <math.h>
/* HAPUS KOMENTAR INI  JIKA PENGGUNA MENGGUNAKAN FREEGLUT
#include <GL\glew.h>
...
int main(int argc, char* argv[]) {
    /* =========================  UNTUK PENGGUNA FREEGLUT  =========================  
    * HAPUS KOMENTAR UNTUK :      
                            glutInit(&argc, argv); 
                            #include <GL\glew.h>
                            #include <GL\freeglut.h>
    */
